...
![進行不能やデータ不整合を最優先に、操作不能や不公平、軽微な乱れの順に対処する物理破綻時の判断フロー](image/physics-failure-fallback-priority-flow.webp)
...
![重大度と再現性で物理不具合をS・A・B・Cに分類する判定マトリクス](image/physics-defect-severity-reproducibility-matrix.webp)
