...
```
# 仕上げAIへ図表制作依頼
取適法の適用判定フローを制作する。横長の日本語フローチャートとし、起点を「スタジオ間の業務委託」とする。第1分岐は「委託内容はプログラムの作成か」。YESは「資本金基準：3億円／1,000万円の2段階」および「従業員基準：300人超→300人以下」、NOは「デザイン・映像等のプログラム以外の情報成果物か」を確認したうえで「資本金基準：5,000万円／1,000万円の2段階」および「従業員基準：100人超→100人以下」へ進める。資本金基準に該当しない場合でも従業員基準を確認し、いずれかに該当すれば「取適法の対象になり得る」、いずれにも該当しなければ「取適法以外の契約・独占禁止法上の検討は残る」とする。ゲームソフトはプログラムの例であることを短い注記で示す。数字を変更・省略しない。最終的な適用判断は個別確認が必要である旨を図外注記に置く。
```
...
```
# 仕上げAIへ図表制作依頼
多重下請構造と「下流しわ寄せ型」を示す横長の構造図を制作する。上から下、または左から右へ「エンドユーザー → 元請 → 中間下請 → 最終下請」と配置し、各層の間に契約・発注の矢印を置く。上流で生じた「予算削減」「仕様変更」「入金遅延」が、下流へ進むにつれて「単価据え置き」「無償追加作業」「検収・支払遅延」へ変換されて連鎖することを別色の太い矢印で示す。中間層の存在自体を悪と描かず、「情報整理・品質管理・与信などの役割がある場合」と「実質的な関与が乏しい場合」を区別する小注記を入れる。公正取引委員会2022年調査に基づく概念図であり、特定企業の商流を示すものではないと明記する。図中の文字量は読者幅で読める範囲に抑える。
```
...
契約期間と秘密保持義務の存続期間も別に読む必要がある。特許庁のモデル契約解説は、契約期間が短くても残存条項によって契約終了後10年など長期間の秘密保持義務を負う場合があると説明する。[[14](#ref-14)] 技術情報の価値が続く間を基準に、無期限または実質的に長期の義務を置く契約もある。企業法務を扱う法律事務所の解説も、極めて重要な情報では無期限または相当程度長い期間を検討する場合がある一方、通常は情報の内容と技術革新の速度に応じて合理的な期間を決める必要があると整理している。[[16](#ref-16)] 対象情報、例外、公知化、独自開発、返還・消去、存続期間を一組で確認したい。

法人がNDAの当事者でも、情報に触れるのは個々の開発者である。実務では、閲覧者をプロジェクトメンバーに限定し、参加者個人から別の秘密保持誓約書を取得することがある。経済産業省の営業秘密管理に関する調査でも、特定プロジェクトの参加時に従業員へ個別のNDA・誓約書への署名を求める例が報告されている。[[15](#ref-15)] その場合、開発者個人は会社の就業規則だけでなく、個別に署名した誓約にも拘束される。退職・異動・契約終了後に何が残るかは、法人間NDAと個人向け文書を分けて確認する必要がある。
...
<a id="ref-15"></a>15. [経済産業省「営業秘密管理に関する実態調査」][15] - 特定プロジェクト参加者へ個別のNDA・誓約書への署名を求める管理例を紹介する。

<a id="ref-16"></a>16. [モノリス法律事務所「秘密保持契約書（NDA）作成におけるチェックポイント」][16] - 秘密保持義務の存続期間は一定期間とする例が多い一方、重要情報では無期限または長期も検討されると説明する。
...
[15]: https://www.meti.go.jp/policy/economy/chizai/chiteki/pdf/h26jittai.pdf
[16]: https://monolith.law/corporate/checkpoints-nondisclosure-agreement
