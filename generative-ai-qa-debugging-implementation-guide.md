...
生成AIに対する期待と反発が併存していることは、2026年にも変わらない。GDCの2026年調査では、ゲーム業界の回答者の36％が仕事で生成AIツールを使っている一方、52％は生成AIがゲーム業界に悪影響を与えていると回答した。[[2](#ref-2)] この数字は、業界全体が導入に合意したことを意味しない。
...
- スクウェア・エニックスの公開資料は「2027年末までにQA・デバッグ作業の70％を自動化する」という目標を示しているが、70％の分母、対象タスク、合否水準、QA人員への影響は明らかにしていない。本稿では人員削減の意味に読み替えていない。
- CEDEC2026は2026年7月22日から24日に開催予定であり、本稿執筆時点では「スクリプト不要、仕込みも最小限。動画と生成AIで挑むゲームQAの現在地」は公式タイムテーブルのセッション概要に基づいている。講演後に実装結果や数値が公開された場合は、本文を更新する必要がある。
- GDC 2026の調査は2,300人超の回答に基づく業界調査であり、全ゲーム会社の導入率やQA職種だけの実態を表すものではない。本稿の「実装フェーズへの移行」は、公開投資・研究・技術ロードマップから見た実務上の整理であり、業界全体の合意を意味しない。
- AIが面白さ、バランス、プレイヤーの納得感を評価できる範囲は、タイトルのジャンル、データ、評価設計によって変わる。統計値だけで人間の体験評価を置き換えられるという意味ではない。
