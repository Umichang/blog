...
![2014年の発掘で掘り出されたアタリ関連パッケージ類（ニューメキシコ州アラモゴード埋立地）](image/atari-et-landfill-excavation.webp)

*画像引用：撮影 taylorhatmaker ／ [CC BY 2.0](https://creativecommons.org/licenses/by/2.0/) ／ [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Atari_E.T._Dig-_Alamogordo,_New_Mexico_(14036097792).jpg) 経由*
...
![北米家庭用ゲーム市場規模の推移（1980〜1985年）。ピーク約32億ドルから1億ドル以下へ約97%減](image/na-game-market-crash-1980-1985.webp)
...
![ファミコン時代の初心会流通ルート](image/famicom-shoshinkai-distribution.webp)
...
![流通モデルの比較：初心会方式（前払い・返品リスクは問屋／小売）とSCE方式（前払い不要・在庫リスクはSCEが肩代わり）](image/playstation-sce-distribution.webp)
