...
優先度：🔴A
種類：棒グラフ
タイトル：スマホゲーム事業者の倒産件数推移
データ：
- 2015年（過去最多）：12件
- 2025年（前年通年）：3件
- 2026年1〜7月：10件
出典：帝国データバンク「スマホゲーム事業者」の倒産動向（2026年8月8日）[[1](#ref-1)]
留意点：2026年のバーには「1〜7月時点（実数）」等の注記を添え、年間換算値ではないことを明示する。過去最多の2015年に迫る位置関係が一目でわかる配色・並びにすること。
```
...
優先度：🟢C（任意）
種類：インフォグラフィック（対比図）
タイトル：モバイルAAA級タイトルの開発費・運営費の規模感
データ：
- 開発フェーズ：開発費40億円以上／開発期間32カ月／開発人数200人月
- 運営フェーズ：運営費 月1億円以上／体制50人以上
出典：CESA、経済産業省「第12回エンタメ・クリエイティブ産業研究会 業種分野別専門委員会（ゲーム）」提出資料（2026年2月4日）[[8](#ref-8)]
留意点：開発と運営を左右または上下に分けた対比構成とし、「運営費は月額であり単純な12倍以上の負担が長期継続する」ことが伝わる注記を添える。数字を大きく見せる演出よりも、開発・運営の性質の違いが伝わることを優先する。
```
...
優先度：🟡B
種類：対比グラフ（棒グラフまたは二軸図）
タイトル：国内スマホゲーム市場と世界モバイルゲーム市場の対比
データ：
- 国内スマートフォンゲームアプリ市場：2023年 1兆2,351億円（前年比0.7%減、3年連続マイナス）
- 世界モバイルゲーム市場：2025年 12兆6,001億円（前年比1.4%増）。同資料では日本市場は前年比96.2%
出典：角川アスキー総合研究所『ファミ通ゲーム白書』（[[9](#ref-9)]）、『ファミ通モバイルゲーム白書2026』を引用する上場企業開示（[[10](#ref-10)]）
留意点：集計年（国内2023年／世界2025年）が異なる点を図中に注記する。世界の緩やかな成長と国内の微減という方向の違いが直感的にわかる配色にすること。絶対額の大小比較ではなく、成長方向の対比が主眼である。
```
