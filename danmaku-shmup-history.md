...
東亜プランの『タイガーヘリ』と『究極タイガー』は、ショットとボンバーを軸にした縦スクロールSTGの基本形を広めた。 **ボム** とは、回数制限のある強力な攻撃で、多くの作品では敵弾消去や一時的な無敵を伴う。M2の公式紹介も、『タイガーヘリ』をショット＋ボンバーの基本形を生み出した作品と位置づけている。[[6](#ref-6)]
