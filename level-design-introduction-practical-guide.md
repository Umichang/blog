...
![良いペースの強度の波と、刺激が高止まりする悪いペースを比較したグラフ](image/level-design-pacing-intensity.webp)
...
![安全に試す、応用する、試されるという学習設計と、最初から本番難度に進む失敗ルート](image/level-design-learning-flow.webp)
