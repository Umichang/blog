...
# 仕上げAIへ図表制作依頼
🔴必須
1999年「ハイキーショット」の美白、2007年「美人-プレミアム-」のデカ目、2011年「LADY BY TOKYO」のナチュラル盛り、現在の左右差・顔サイズなどの微調整レタッチを、横方向の年表として示してください。
各時点に「社会側の美意識」と「機械側で作り替えた写り」を上下2段で対応させ、「強い加工から弱い加工へ一直線に進化した」のではなく、評価基準が反転したことが分かる構成にしてください。
数値グラフではないため概念年表として制作し、記事にない機種・年・流行を追加しないでください。
```
...
# 仕上げAIへ図表制作依頼
🔴必須
プリントシール機の「撮影→顔・特徴点の検出→人物ごとの変形・領域別補正→表示・レタッチ→印刷／画像送信」という処理フローを、横方向の工程図で示してください。
顔検出後に複数人へ別々の処理を適用し、立ち位置が変わっても選択内容が人物へ追従することを中央に示してください。
全工程の下へ「待ち時間を増やさない制約」を一本の帯として置き、各処理をコンマ何秒単位で短縮する必要があることを表現してください。
具体的な処理秒数は資料にないため、架空の数値や合計時間は入れないでください。
```
...
# 仕上げAIへ図表制作依頼
🟡推奨
JAIA公表のプリントシール機オペレーション売上高の長期推移を、折れ線グラフで示してください。
縦軸は売上高（億円）、横軸は年度とし、本文および表に記載のある次の実数値のみをプロットしてください。
1996年度603億5,100万円、1997年度1,013億3,000万円、1998年度417億9,300万円、2019年度約257億円、
2020年度239億6,100万円、2021年度172億3,000万円、2022年度142億7,500万円、2023年度192億6,600万円、
2024年度191億1,200万円。
1998年度から2019年度までは本文が「2008年度以降はおおむね250億円弱の水準で推移」とのみ述べており、
各年度の実数値は記事にないため、この区間は実線で結ばず、破線または注記で「おおむね250億円弱で推移」
と示す形にしてください。存在しない年度の数値を補完・推定して描かないでください。
1997年度の突出したピーク、翌年度の急落、長期の横ばい、コロナ禍の底、その後の頭打ちという形状が
読み取れることを最優先にしてください。
グラフには「オペレーション売上高（筐体の出荷額ではない）」であることを明記してください。
```
