---
description: "ゲーム開発でGitやSVNだけでは扱いにくい大容量アセットを、バージョン管理、共有、ロック、制作工程の観点からどう運用するかを解説する。"
---
...
![GitとSVNの構造比較。Gitは作業者ごとにローカル履歴と作業ツリーを持ち、SVNは中央サーバーと作業コピーを接続する模式図。](image/version-control-git-svn-structure-comparison.webp)
...
<p align="center">
  <img src="image/version-control-binary-conflict-flow.webp" alt="同じTown.sceneをAとBが同時編集し、提出と更新を経てコンフリクトと再作業に分岐する流れ。" width="560">
</p>
