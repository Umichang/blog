...
- 本稿は2026年7月11日時点で公開されているCEDEC2026の開催情報とセッション概要、各IPの公式情報に基づく予習記事である。講演本編で示される企画手順、判断基準、成果指標を先取りして断定していない。
- CEDEC2026のセッション内容、開催情報、各種コラボレーションの実施時期は、公式サイトの更新によって変更される可能性がある。聴講時は最新の公式タイムテーブルと講演資料を優先されたい。
- 『ブルーアーカイブ』のASMR商品化は2022年時点で公式例が確認できるため、『ヘブンバーンズレッド』固有の初出とは扱っていない。本稿での独自性の整理は、ASMRと舞台化の組み合わせに着目した比較上の位置づけである。
