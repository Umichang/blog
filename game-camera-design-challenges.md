---
description: "3Dゲームのカメラは、キャラクターの後ろへ置けば完成するように見える。しかし実際には、壁へ入らず、必要な対象を隠さず、入力を邪魔せず、狭い場所でも破綻しないことを同時に求められる。"
---
...
![カメラコリジョンと視界遮蔽は別問題であることを示す概念図](image/game-camera-collision-vs-visibility-v2.webp)
...
![ジャンプ中のキャラクターがデッドゾーン、ソフトゾーン、外側へ移るにつれてカメラ補正が強くなることを示す概念図](image/game-camera-dead-soft-zone-v2.webp)
...
![通常時と方向転換時で先読み注視点の働きが変わることを示す概念図](image/game-camera-lookahead-tradeoff.webp)
...
![通常プレイから演出カメラへ移り、制御復帰するまでのタイムライン図](image/game-camera-cinematic-blend-timeline.webp)
