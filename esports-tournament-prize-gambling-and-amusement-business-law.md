---
description: "eスポーツ大会の高額賞金を、賭博罪の偶然性と財物の得喪、賞金原資、風営法5号営業の会場・機材設計から整理する。"
category: legal-regulation
difficulty: yellow
---

# eスポーツ大会賞金の賭博法制論点――なぜプロゴルフの高額賞金は疑問視されず、eスポーツは賭博では疑われるのか
...
```
# 仕上げAIへ図表制作依頼
「賭け金プール型」と「第三者賞金型」の資金フローを左右比較する概念図を制作してください。
左側は、複数の参加者が金銭を一つのプールへ出し、勝者がそのプールを得るため、敗者の損失と勝者の利益が対応する構造を示してください。
右側は、参加料が会場費・機材費・審判費・配信費などの運営費へ流れ、スポンサー・パブリッシャー・主催者が別系統で賞金を拠出して勝者へ支払う構造を示してください。
中央に「見るべき点は賞金額ではなく、参加者の財産が勝敗で移転するか」と短く置いてください。
法律上の適法性を図だけで断定せず、左側は「賭博罪のリスク」、右側は「参加料と賞金原資を実質的に分離」と表現してください。
日本語ラベルは上記の短い語句に限定し、資金の向きを矢印で明確にしてください。
```
...
```
# 仕上げAIへ図表制作依頼
縦方向に3段階を並べた判断フロー図を制作してください。
上から「①5号営業の定義に該当するか」「②都道府県公安委員会の許可が必要か」「③許可を得て営業するための構造・設備基準（照度10ルクス超、見通しの確保、騒音・振動基準など）を満たす」の順に並べ、矢印で上から下へつなげてください。
③の枠の横に、小さく「アーケード出身プランナーが引っかかりやすい場所」という注記を添えてください。
図の下または横に短い一文で「照度・見通しは③の話であり、①の該当性を消す条件ではない」と置いてください。
日本語ラベルは上記の短い語句に限定し、余計な装飾は避けてください。
```
