---
description: "ゲームのアクセシビリティと聞くと、発売直前に字幕や色覚サポートを足す仕事を想像しやすい。しかし、その理解では遅い。"
...
声を出せない状況と、音声以外の操作経路を残す設計については、[『鼻歌でも、実物のオカリナでもいい ― Switch 2 が音声入力に出した答え』](switch2-microphone-voice-and-melody-input-design.md)でも考察する。声や楽器で参加する方法を増やすことと、静かに遊べる方法を残すことは、両方が必要になる。
