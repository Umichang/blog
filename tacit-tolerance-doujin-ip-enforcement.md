...
```
# 仕上げAIへ図表制作依頼
二次創作に対する法的・実務的な分岐を示す横長の概念図を作成してください。
左に「二次創作物を発見」、中央に「民事：許諾がなければ侵害となり得る」「刑事：原則は権利者の告訴が入口」「例外：原作のまま・利益目的等・市場への不当な害を満たす海賊版型は非親告罪」を配置し、右に「黙認」「連絡・修正要請」「差止め・損害賠償」「重大案件の刑事対応」を段階的に並べてください。
「黙認＝許諾・合法化ではない」を目立つ注記にしてください。特定作品のキャラクターやロゴは使わず、日本語の短いラベルだけで構成してください。
```
...
```
# 仕上げAIへ図表制作依頼
ポケモン同人誌事件の影響が個人から業界へ広がる時系列図を作成してください。
「1998年夏 同人誌制作・頒布」→「1999年1月13日 逮捕」→「22日間拘束・罰金10万円」→「転居・100万円超の借金」→「1999年3月17日 印刷会社社長を書類送検」→「即売会主催者の連絡組織化」→「ケモノオンリー成立まで約10年の時間差」の順にしてください。
事件をセンセーショナルに描かず、個人・流通・業界・長期影響の4層が分かる落ち着いた資料図にしてください。特定作品のキャラクターやロゴは使わないでください。
```
...
```
# 仕上げAIへ図表制作依頼
二次創作への対応を「観察」「連絡・修正要請」「頒布停止・削除要請」「民事・刑事対応」の4段階で示す、下から上へ積み上がる縦型の階段状（エスカレーション）図を作成してください。
各段には短いラベルとともに、代表的な対応内容を一言添えてください（観察：静観・記録のみ／連絡・修正要請：ロゴ使用や表記の修正依頼／頒布停止・削除要請：販売停止・削除の要請／民事・刑事対応：差止め・損害賠償・重大案件の告訴）。
下段（観察）ほど発生頻度が高く穏やかな対応、上段ほど発生頻度が低く重い対応であることが視覚的に伝わるようにしてください。特定作品のキャラクターやロゴは使わず、日本語の短いラベルだけで構成してください。数値グラフではありません。
```
