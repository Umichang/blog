...
ログインボーナス（以下「ログボ」）は、F2P（Free-to-Play）モバイルゲームにおいて最も広く普及した継続率施策のひとつである。しかし「とりあえず実装する」という慣習的な設計は、むしろプレイヤーの離脱を加速させる逆効果を招くことがある。本稿では、ログボの役割と心理的メカニズムを整理したうえで、効果的な報酬設計の原則、非計画的実装による失敗パターン、そして「おみくじ型ログイン」という新しいアプローチを論じる。対象読者はゲームを深く知りたいプレイヤーから、ゲームプランナーの卵まで幅広く想定している。[^1]
...
1. [【ゲームアプリ】ログインボーナスの役割効果と作り方・設計実装 ...](https://gamemarketinglab.com/login_bonus/) - 今回はスマホゲーム開発では定番のログインボーナス機能について解説します。実はログイン ... 継続率に貢献するインセンティブを明確してログボに実装する ...

2. [How to Measure F2P Game Retention - Bright Black Associates](http://brightblack.co/blog/f2p-game-retention) - In this case, your range retention rate is 19.2% for the first retention period. If 8 people return ...

3. [ポケモンGO、驚異の継続率。ほかのゲームアプリの2倍以上](https://news.yahoo.co.jp/expert/articles/83c9da83fd3e53f51f02e0f7ade43e59d6bd5c1a) - 継続率とはダウンロードしたユーザーが○日後までに何％遊んでいるかを表すもので、ゲームアプリの場合、1ヶ月後にはおよそ10～20％になってしまうと言われ ...

4. [連続ログインボーナスは絶対にやめて！個人開発ゲームでユーザー ...](https://note.com/plus00/n/n13b56b549623) - 今回は、個人開発ゲームにおける連続ログインボーナスの問題点と、それに代わる方法についてお話ししたいと思います。 ぜひ最後までお付き合いください。

5. [ログインボーナスはどの仕組みが良いかを検討してみた話](https://dev.classmethod.jp/articles/loginbonus/) - ログインボーナスとは、その名の通りアプリやゲームにログインした際に付与される付加価値のことです。 ユーザーにとっては、毎日アプリケーションを立ち ...

6. [Using Psychology in Games: An in depth perspective - LinkedIn](https://www.linkedin.com/pulse/using-psychology-games-depth-perspective-troy-dunniway) - Ratio schedules provide rewards after a number of actions are taken by a player, whereas an interval...

7. [Variable Ratio | Reinforcement Schedule & Examples - Lesson](https://study.com/learn/lesson/variable-ratio-schedule.html) - In particular, a variable ratio reinforcement schedule is one in which individual responses will ran...

8. [Curiosity and Its Influence on Children's Memory](https://par.nsf.gov/servlets/purl/10062657) - H Walin 著 · 2016 · 被引用数: 24 — When an information gap in a particular knowledge network is made sali...

9. [【スマホゲーム】ログボよりリテンション効果あり！7日間 ...](https://gamemarketinglab.com/day7_challenge/) - 7日間のログインボーナスとミッションを組み合わせることで、独自の「7日間チャレンジ機能」をその都度、考え実装していると思われます。 新規ゲームの ...

10. [【ASO対策】アプリの継続率を高める対策方法と重要点](https://glass-inc.jp/media/aso_retention/) - 継続率対策方法は以下の通りです。それぞれについてご紹介します。 ログインボーナス; プッシュ通知; レビュー返信. ログインボーナス. アプリが起動 ...

11. [ログインボーナスは「ログインしていない期間の分も貰える」のが ...](https://note.com/ogataiki/n/n7723489a1cde) - 連続ログインボーナスは、ログインしない日があると1日目のボーナスに戻るというデメリットによる強迫性と連続するほど良い報酬が貰える設計でログインの ...

12. [フォロー＆リポストでバイオみくじを引こう！ 『バイオハザード ...](https://prtimes.jp/main/html/rd/p/000004159.000013450.html) - 本キャンペーンでは、「バイオハザード」ブランド公式X（旧Twitter）（@REBHPortal）をフォローして、指定の投稿をリポストすると、バイオハザードの ...

13. [アプリ継続率（リテンションレート）とは？メリットや計算式](https://metabadge.cloudcircus.jp/media/column/retention-rate) - まずは会員登録などの入力ステップを最小限にし、機能の利用体験を優先させる設計が効果的です。また、静止画の説明文を読ませるのではなく、実際に ...

14. [強化スケジュール | ITカウンセリングLab](https://it-counselor.net/psychology-terms/reinforcement-schedule) - 強化スケジュールとはオペラント条件づけ・道具的条件づけにおいて、強化子（報酬などの刺激）をどのような間隔や時間で与えるかの配分方法。

15. [バイオハザード ポータル | CAPCOM](http://game.capcom.com/residentevil/sp/ja/news-4751.html) - 開運！ バイオハザードおみくじキャンペーン 1日目＼ フォロー&RPをして全10種のバイオハザードおみくじ画像をゲット その場で最大5万円分のAmazonギフト券が当たる ...

16. [The Science & Craft of Designing Daily Rewards - Game Developer](https://www.gamedeveloper.com/business/the-science-craft-of-designing-daily-rewards----and-why-ftp-games-need-them) - This post explains how to optimize this mechanic through long-established behavioral economics' prin...
