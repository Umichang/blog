...
一つ目は、**対人競技としての強さ**を軸にしたe-sportsだ。プレイヤー同士が技を競い合い、企業スポンサーと興行モデルが結びついた、明確に「勝者と敗者がいる」スポーツ的文脈のコンテンツである。二つ目は、**キャラクターへの感情移入**を駆動力にしたにじさんじ甲子園のような祭典だ。VTuberという人格に共感したファンが、推しを応援するためにゲームの勝敗を見守る。
...
```
# 仕上げAIへ図表制作依頼
上記の寄付実績テーブル（2018年12月〜2025年12月、全14回）を可視化した折れ線グラフまたは棒グラフを制作してください。
- 横軸：開催回（時系列順）
- 縦軸：寄付総額（万円）
- 2020年8月（東京大学基金）は寄付先が国境なき医師団と異なるため、色分けや注記で区別してください。
- 2018年・2019年（日本赤十字社、各数万円）は金額差が大きいため、対数軸の利用や、当該2回を別枠の小さな棒で示すなど、2020年以降のスケールを潰さない表現を検討してください。
- 右肩上がりの成長が一目で分かる見せ方を優先してください。
```
