...
```
# 仕上げAIへ図表制作依頼
横長の概念図を作成してください。左から右へ「プレイヤー」「決済代行業者・カードネットワーク・銀行」「Steam」「海外パブリッシャー」「日本の開発者の銀行口座」「インディー開発者」を並べ、資金の流れを矢印で示してください。「販売段階のボトルネック」はSteamの手前、「受取段階のボトルネック」は国内銀行口座の手前に赤い遮断記号で示します。上段に2025年7月以降のSteam配信停止、下段に2026年の日本国内銀行による入金拒否を対応させ、両者を一本の因果関係で結ばない構成にしてください。数値グラフではなく、金融インフラの二層構造を示す簡潔な概念図です。
```
...
```
# 仕上げAIへ図表制作依頼
関係者の影響の向きを示す簡易相関図を作成する。
「Collective Shout」→（働きかけ）→「決済代行業者・カードネットワーク」→（基準の提示）→「Steam / itch.io」→（配信停止・審査）→「開発者」の一方向の矢印で並べる。
Collective Shoutは働きかけの主体であり、配信停止の実行者ではない点、決済関係の判断は金融事業者が行う点を注記に添える。
数値グラフではなく概念図。若手ゲームプランナー向けの簡潔な教材風とし、本文にない固有名詞や数値を追加しない。
```
...
Steam上の規制は、プレイヤーが作品を買う入口を止める。2026年に日本で相次いで公表された事例は、売上が海外パブリッシャーから開発者へ届く出口で起きた。ここでいう **デバンキング** は、口座の全面解約に限らず、銀行が特定の送金を受け付けず金融サービスへの接続を断つ状態を指す便宜的な呼び方である。

### りそな銀行と『シュブニグラスの夜』開発者

2026年4月16日、Game*Sparkは、サークルRENを主宰し『シュブニグラスの夜』を開発するイツキ舞が、海外パブリッシャー072 Projectからりそな銀行口座への送金を受け取れなくなった事例を報じた。実際の入金停止は同年3月に始まったとされる。イツキは販売実績や作品の表現基準を説明したが、銀行の判断は変わらなかった。[[11](#ref-11)]
...
2026年8月5日には、『ヤリステメスブター』の開発者ぬぷ竜が、台湾のパブリッシャーから楽天銀行への海外送金を拒否された事例が報じられた。銀行から送金者との関係や取引内容を示す資料を求められ、契約書などを提出した後も、入金は認められず、理由は回答できないと通知されたという。[[12](#ref-12)]
...
2026年8月10日、『私たちフェイクマリッジ？』の開発者で、百合ゲームブランド「黒彩黄泉路」を運営する滝井ノアメは、同作の発売延期を発表した。8月12日のGame*Spark報道によると、同作は成人向け描写を含まない全年齢向けの百合恋愛アドベンチャーである。それでも、海外パブリッシャーからの売上を受け取る経路を確保できないことが延期の背景になった。[[13](#ref-13)]
...
ゆうちょ銀行は、海外からの送金をすべて内容確認のうえで入金し、送金目的や原資、送金人との関係を示す資料を求める場合があると案内している。資料から法令・規制上必要な確認ができないと判断した場合や、取引相手の詳細情報を得ることが難しいと判断した場合には、入金を断ることがある。[[14](#ref-14)] ただし、この一般的な案内だけで滝井の個別事例の拒否理由を特定することはできない。
...
日本政府と金融庁がマネー・ローンダリング、テロ資金供与、金融犯罪への対策を強化していること自体は公表資料で確認できる。金融庁は2026年7月の報告書でも、金融機関のリスク管理態勢の有効性確保と高度化を掲げている。[[15](#ref-15)] 一方、元国会議員で表現の自由に関する活動を行うくりした善行による、こうした規制強化がデバンキング事例へ影響している可能性があるとの発言は、関係者による推測である。三つの入金拒否をAML、すなわちマネー・ローンダリング対策の結果だと確定する銀行や当局の資料は公表されていない。
...
```
# 仕上げAIへ図表制作依頼
本記事で扱う主要な出来事を並べた横長の時系列タイムライン図を作成する。
上段に「Steam・決済網側」の出来事、下段に「日本国内銀行側」の出来事を配置し、時間軸は共通で左から右へ進める。
上段：2025年7月16日（Steam配信ガイドライン改定）、2025年7月19日（Valveの公式回答）、2025年8月1日（Mastercardの否定声明）、2025年8月2日（Valveの反論）。
下段：2026年4月16日（りそな銀行、『シュブニグラスの夜』開発者）、2026年8月5日（楽天銀行、『ヤリステメスブター』開発者）、2026年8月12日（SBI新生銀行・ゆうちょ銀行、『私たちフェイクマリッジ？』開発者）。
上段と下段の間に「発生源が異なる二つの層」であることを示す注記を添える。
数値グラフではなく概念図（タイムライン）。若手ゲームプランナー向けの簡潔な教材風とし、本文にない固有名詞や数値を追加しない。
```
...
<a id="ref-11"></a>11. [成人向けゲームを海外パブリッシャー経由してSteamで販売したら日本への送金が国内銀行により停止された][11] - イツキ舞、072 Project、りそな銀行の入金拒否と書面回答。

<a id="ref-12"></a>12. [数十万本ヒット成人向け『ヤリステメスブター』開発者、Steamからの売上を銀行に受け取り拒否されたことを明かす〖UPDATE〗][12] - ぬぷ竜の楽天銀行事例、販売本数、拒否対象作品に関する本人補足。

<a id="ref-13"></a>13. [Steam全年齢向け百合ゲー、銀行からの入金拒否を受け発売延期][13] - 『私たちフェイクマリッジ？』の発売延期とSBI新生銀行・ゆうちょ銀行の入金拒否。

<a id="ref-14"></a>14. [国際送金のお受け取り（外国から日本への送金）][14] - ゆうちょ銀行による被仕向送金の確認と入金拒否がありうる条件の一般案内。

<a id="ref-15"></a>15. [「マネー・ローンダリング等及び金融犯罪対策の取組と課題（2026年7月）」の公表について][15] - 金融庁が示す2025事務年度の対応状況と対策高度化の方針。
...
[11]: https://www.gamespark.jp/article/2026/04/16/165251.html
[12]: https://www.gamespark.jp/article/2026/08/05/170232.html
[13]: https://www.gamespark.jp/article/2026/08/12/170561.html
[14]: https://www.jp-bank.japanpost.jp/kojin/sokin/kokusou/kj_sk_ks_gaikoku.html
[15]: https://www.fsa.go.jp/news/r8/260703/20260703.html
