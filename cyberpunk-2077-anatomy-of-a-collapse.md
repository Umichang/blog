...
| 問題の構造 | Cyberpunk 2077での現れ方 | 現場で確認すべきこと |
|---|---|---|
| **スコープの肥大化** | マルチプレイヤー同時開発の構想[[23](#ref-23)]、旧世代機への対応維持[[14](#ref-14)] | 「作れる」と「出荷できる」を分け、最小出荷スコープと未達リスクを明文化する |
| **期待値の自己肥大** | 2012年発表〜2020年リリースまでの8年間のハイプ[[1](#ref-1)] | 公開情報がプレイヤーへの約束として受け取られることを前提に、変更時の説明責任を見積もる |
| **プラットフォーム別品質管理の欠如** | PC版と旧世代コンソール版の品質格差を最後まで隠蔽[[4](#ref-4)][[20](#ref-20)] | ターゲットプラットフォームごとに独立した品質基準と検証結果を持ち、差分を可視化する |
| **クランチと品質の矛盾** | 「クランチなし」宣言と週6日勤務義務化[[17](#ref-17)][[16](#ref-16)] | 工数不足を残業で吸収する前提になっていないかを確認し、品質・人員・納期のトレードオフを記録する |
| **透明性を欠いたレビュー解禁ルール** | コンソール版をメディアに提供せず自社映像のみ許可[[20](#ref-20)][[22](#ref-22)] | 短期的な情報統制が、発売後の返金・炎上・信頼毀損として戻ってくる可能性を評価する |

Cyberpunk 2077の事例が示すのは、「技術的な失敗」以上に **「判断の連鎖的な失敗」** がいかにプロジェクトを崩壊させうるかだ。ただし、この規模のリリース判断やマーケティング方針は、現場の一プランナーが単独で止められるものではない。できることがあるとすれば、スコープ、品質、納期、公開情報のズレを早い段階で言語化し、上層部が判断できる材料として提示することだ。

それでも、大型プロジェクトでは、そうした提案が常に通るとは限らない。発売時期、株主への説明、市場機会、既に積み上がった宣伝費といった要因が、現場からのリスク指摘を押し返すことは十分にありうる。だからこそプランナーにとって重要なのは、「自分ならこの崩壊を防げた」と考えることではなく、同じ構造が自分の関わるプロジェクトで小さく芽を出したときに、何を観測し、どう記録し、どのタイミングで提案として上げるべきかを知っておくことである。
