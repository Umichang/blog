...
本作の戦闘空間は、潜入専用、銃撃専用と明確に分けられてはいない。遮蔽物、迂回路、投擲できる物、敵の視線と配置が同じ空間に置かれ、プレイヤーは状況に応じて隠密と戦闘を行き来する。PlayStation.Blogが発売前に「シューターではない」と表現したのは、射撃の頻度ではなく、射撃を万能な正解にしない構造を指している。[[9](#ref-9)]

この往還を支える一つがリスニングモードである。周囲の敵の位置を把握できる情報は、闇雲な待機を減らし、迂回、待ち伏せ、投擲、静かな排除といった計画を立てる材料になる。公式紹介でも、リスニングモードで敵を見つけ、消音武器で側面を取るステルスの使い方が示されている。[[11](#ref-11)]
...
敵AIは強さだけで分類するものではない。何を見て、何を聞き、どのように追うかは、プレイヤーに何を恐れさせるかを決める。本作では感染者と人間の敵対集団が同じ空間で異なる圧力を持つ。Travis McIntoshがNaughty DogのリードプログラマーとしてGDC 2014で行った「The Last of Us: Human Enemy AI」は、人間敵AIについて、ナビゲーション、リアルタイムのレベル分析、戦闘、捜索、ステルスの意思決定を扱った講演である。[[12](#ref-12)]

### 感染者は、接近の恐怖を身体へ寄せる

感染者には、走って接近するランナーと、クリック音を用いるクリッカーがいる。公式のシリーズ紹介は、感染者が音、視覚、反響定位によって未感染者を検知し、感染段階ごとに性質が異なると説明している。[[13](#ref-13)]
...
人間の敵は、遮蔽物を使い、捜索し、戦闘とステルスに応じた振る舞いを持つ。McIntoshの講演が人間敵AIを独立して扱ったこと自体が、本作で人間の遭遇が単なる射撃対象ではなく、空間を分析してプレイヤーを追い詰める仕組みとして設計されたことを示している。[[12](#ref-12)]
...
Naughty DogのエンジニアであるMax Dyckhoffは、GDC 2014の「Ellie: Buddy AI in The Last of Us」で、この問題を扱った。講演内容を収録した論文は、開発終盤まで敵が同行者を視認できる構成を試していたが、潜入中の同行者を敵NPCから不可視にする判断へ至ったと説明する。同行者が一度でもプレイヤーの位置を露呈させれば、プレイヤーとの絆が損なわれることを避けるためである。[[14](#ref-14)]
...
『The Last of Us』のシングルプレイは、一本の強いメカニクスだけで成立しているわけではない。資源経済は「いま撃つ」ことへ将来の代価を与える。遭遇は潜入と戦闘の間を行き来させ、発見後にも判断を残す。感染者と人間は異なる知覚モデルで、近接の恐怖と捜索される不安を描き分ける。エリーのAIは、現実らしい判定を一部手放すことで、プレイヤーの潜入の意図と二人の関係を守る。
...
- 本稿はPS3版の難易度ごとの個別ドロップ確率を本文に記載していない。公開済みの一次資料では確率値を確認できなかったためである。資源量と敵ドロップが難易度調整の対象になることは、『The Last of Us Part I』の公式仕様を補助資料として参照した。PS3版の難易度別テーブルを扱う場合は、当時の公式マニュアルまたはNaughty Dogの仕様資料で別途確認が必要である。
- 人間敵AIに関する分析はTravis McIntoshのGDC 2014講演を主資料とした。感染者AIとの詳細な実装比較は、Naughty Dogの同等の公開技術講演を確認できていないため、本文では公式の知覚説明とプレイ体験から読める設計上の役割に限定した。
...
<a id="ref-11"></a>11. [The Last of Us Multiplayer Revealed][11] - PlayStation.Blog、2013年6月4日。リスニングモードを使った敵の位置把握と側面攻撃の説明。

<a id="ref-12"></a>12. [The Last of Us: Human Enemy AI][12] - Travis McIntosh（Naughty Dog）、GDC 2014。人間敵AIの意思決定、ナビゲーション、レベル分析、戦闘、捜索、ステルスの講演概要。

<a id="ref-13"></a>13. [Discover The Last of Us][13] - PlayStation。感染者の段階と、音・視覚・反響定位による検知の公式紹介。

<a id="ref-14"></a>14. [Ellie: Buddy AI in The Last of Us][14] - Max Dyckhoff、Game AI Pro 2、2015年。GDC 2014講演を基にしたコンパニオンAI、潜入中の不可視化、関係性を守る設計の解説。
...
[5]: https://www.interactive.org/images/press_release/17th-Annual-DICE-Awards-Winners-FINAL-2-6-14.pdf
...
[11]: https://blog.playstation.com/2013/06/04/the-last-of-us-multiplayer-revealed/
[12]: https://www.gdcvault.com/play/1020338/The-Last-of-Us-Human
[13]: https://www.playstation.com/en-us/the-last-of-us/
[14]: https://www.gameaipro.com/GameAIPro2/GameAIPro2_Chapter35_Ellie_Buddy_AI_in_The_Last_of_Us.pdf
