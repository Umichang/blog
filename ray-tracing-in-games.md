---
description: "レイトレーシング（Ray Tracing）とは、光の振る舞いを物理的にシミュレートする描画技術である。現実世界の光は、光源から放たれて物体に当たり、反射・屈折・吸収を繰り返しながら最終的に人間の目（あるいはカメラ）に到達する。"
category: visual-spatial-design
difficulty: red
---
...
![Metro ExodusのレイトレースドGI適用スクリーンショット](image/ray-tracing-metro-exodus-rtgi.webp)
*画像引用: [NVIDIA - Metro Exodus: GeForce RTX Real-Time Ray Traced Global Illumination and Ambient Occlusion](https://www.nvidia.com/en-us/geforce/news/metro-exodus-rtx-ray-traced-global-illumination-ambient-occlusion/)（公式掲載スクリーンショット, © 4A Games / Deep Silver / NVIDIA。本文中の屋内RTGI説明に必要な範囲で引用）*
...
![Controlのレイトレースドリフレクション適用スクリーンショット](image/ray-tracing-control-reflections.webp)
*画像引用: [NVIDIA - Control: NVIDIA RTX Ray Tracing Technologies](https://www.nvidia.com/en-us/geforce/news/control-game-rtx-ray-tracing-technologies/)（公式掲載スクリーンショット, © Remedy Entertainment / 505 Games / NVIDIA。本文中のRT反射・屋内照明説明に必要な範囲で引用）*
...
![Gran Turismo 7のレース画面](image/ray-tracing-gran-turismo-7-race.webp)
*画像引用: [Gran Turismo 7 - Products - gran-turismo.com](https://www.gran-turismo.com/us/products/gt7/)（公式商品ページ掲載スクリーンショット, © Sony Interactive Entertainment / Polyphony Digital。本文中のレース中RT反射・車体反射の説明に必要な範囲で引用）*
...
![Cyberpunk 2077 RT Overdriveのネオン照明スクリーンショット](image/ray-tracing-cyberpunk-rt-overdrive.webp)
*画像引用: [NVIDIA - Cyberpunk 2077: Phantom Liberty with GeForce RTX 40 Series](https://www.nvidia.com/en-us/geforce/campaigns/cyberpunk-2077/)（公式掲載スクリーンショット, © CD PROJEKT S.A. / NVIDIA。本文中のRT Overdrive・発光体照明説明に必要な範囲で引用）*
...
![Alan Wake 2の全面レイトレーシング適用スクリーンショット](image/ray-tracing-alan-wake-2-full-rt.webp)
*画像引用: [NVIDIA - Alan Wake 2 Out Now With Full Ray Tracing & DLSS 3.5](https://www.nvidia.com/en-us/geforce/news/gfecnt/202310/alan-wake-2-dlss-3-5-full-ray-tracing-out-this-week/)（公式掲載スクリーンショット, © Remedy Entertainment / Epic Games / NVIDIA。本文中の全面パストレーシング・反射説明に必要な範囲で引用）*
