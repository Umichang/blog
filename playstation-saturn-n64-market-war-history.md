...
| 1996年 | スクウェアが次の『ファイナルファンタジー』を非任天堂機で出す方針を表明 | 有力ソフトの選択が、ハードの将来性についての市場シグナルになった。[[1](#ref-1)] |
...
『ファイナルファンタジーVII』をめぐる出来事は、特定の人物の決断劇として消費するより、プラットフォーム選定の評価軸が可視化された事件として読むべきである。当時の研究は、スクウェアが「必要なゲーム開発環境」を提供する機種としてプレイステーションを選んだという同社サイト上の声明を引用している。[[1](#ref-1)] スクウェア・エニックスの公式情報も、オリジナル版が1997年にPlayStationで発売されたことを確認している。[[7](#ref-7)]
...
<a id="ref-1"></a>1. [The Home Video-Game Industry (1983–1996)][1] - 当時の日本市場における媒体価格、ソフト会社との契約、スクウェアのプラットフォーム選定声明、流通を分析した経営研究資料。
