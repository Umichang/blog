...
| プレイステーション | 1994年12月3日、日本。CD-ROM | 32ビットCPUと3Dグラフィックス、CDベースのソフト | 3D表現とCDを、幅広い開発会社の作品群へつなぐ土台とした。[[4](#ref-4)] |
...
| 1995年5月 | 北米E3でセガサターンを早期発売、ソニーが299ドルを提示 | 小売準備と価格が、発表会の演出ではなく流通上の約束であることを示した。[[6](#ref-6)] |
...
```text
# 仕上げAIへ図表制作依頼
横長の比較インフォグラフィック。中央に「媒体・開発環境・流通・ジャンル」の4項目、左右に日本市場と欧米市場を置く。各市場からプレイステーション、セガサターン、NINTENDO64へ、強みになった要因と制約になった要因を短い日本語ラベルで結ぶ。年表の年号は1994、1995、1996、1997のみ。ハードの実写やロゴは使わず、90年代の技術資料風だが可読性を最優先にする。文字は少なく、本文を読まなくても地域差を把握できる構成にする。
```
...
同じE3で、Sony Computer Entertainment AmericaのSteve Raceが示した「299ドル」は、セガサターンの399ドルとの差額を一語で伝える価格戦略であった。後年の当事者インタビューでも、ソニー側はセガの早期発売を把握した上で価格を準備したと振り返っている。[[10](#ref-10)] 北米と欧州でプレイステーションが1995年9月に発売されたという公式年表も、この演出が実際の市場投入計画と結び付いていたことを示す。[[11](#ref-11)]
...
- 日本国内の最終実売台数は、集計会社、対象期間、出荷と実売の区別で値が変わる。本稿では一次資料で地域別累計を確認できるNINTENDO64以外の細かな国内最終台数を本文へ置かなかった。
- ソニーと個々のサードパーティのロイヤリティ率、開発キット価格、個別契約の交渉経緯は公開一次資料で横断比較できなかったため、具体的な数字や優遇条件は断定していない。
- 専門誌ごとの部数、広告出稿、購買行動への因果効果は、当時の監査可能な統計を追加確認できていない。本文では情報接点としての一般的な役割に限定した。
- セガサターンの世界累計台数はセガの現行公式ページで確認できる統一値を見つけられなかったため、プレイステーション、NINTENDO64との世界累計の直接比較には用いなかった。
