---
description: "ニンテンドーダイレクトは日経報道への対抗から生まれたのか。岩田聡の公式説明と当時の記録を照合し、「直接届ける」方針の継承、E3と各社の発表番組の変化、自分で発表の場を持つ責任をたどる。"
...
```
# 仕上げAIへ図表制作依頼
数値グラフではない概念図。「届ける相手から発表の場を分ける」を示す。
左側に「従来：決算説明会で業績と製品情報を発信」、右側に上下二つの枠を置き、上を「投資家へ：決算説明会」、下を「ゲームファンへ：Nintendo Direct」とする。
右下の補助ラベルは「内容・時間帯を視聴者に合わせる」。本文の2011年10月28日の説明に基づく整理であると図の下に記載する。
メディアを遮断する図、日経から逃げる図、媒体への攻撃を示す矢印は入れない。日本語の文字量を抑え、記事幅で読みやすくする。
```
