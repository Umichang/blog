...
![ファミコン通信アダプタ](image/famicom-communication-adapter.jpg)
...
![XBANDモデム](image/xband-modems.jpg)
...
![ドリームキャスト用モデム](image/dreamcast-modem.jpg)
...
![PlayStation 2ネットワークアダプター](image/ps2-network-adapter.jpg)
*初期型PS2用ネットワークアダプター。*
...
![ゲームボーイ用通信ケーブル](image/game-boy-link-cable.jpg)
*ゲームボーイ用通信ケーブル。*
