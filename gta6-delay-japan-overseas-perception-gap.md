...
```
# 仕上げAIへ画像引用依頼
Rockstar Games公式ニューズワイヤーの記事「Grand Theft Auto VI is Now Set to Launch November 19, 2026」に掲載されている公式ビジュアル（発売延期発表に添付されたキーアート）を、導入部の挿絵として引用候補にしてください。出典をRockstar Games公式サイトと明記し、無改変での使用を条件とします。適切な引用要件を満たせない場合はスキップしてください。
```
...
```
# 仕上げAIへ図表制作依頼
2024年の国内ゲーム人口5,475万人の内訳（モバイル4,278万人／家庭用2,951万人／PC1,452万人）を示したうえで、GTA6が対象とする「家庭用×CERO Z（18才以上）」という区画が、その家庭用市場の中でもさらに狭い一角であることを視覚化する図を作成してください。全体（5,475万人）→家庭用（2,951万人）→CERO Z対象という段階的な絞り込みが一目でわかる構成（漏斗図や入れ子の円グラフなど）にしてください。
```
...
```
# 仕上げAIへ図表制作依頼
GTA6の発売延期の経緯を示すタイムライン図を作成してください。2023年12月（Take-Two／Rockstarが「2025年」発売を発表）→2025年5月（Rockstar Gamesが「2026年5月26日」へ延期を発表）→2025年11月（Rockstar Gamesが「2026年11月19日」へ再延期を発表）の三段階を横軸の時系列で並べ、各段階の発表時期と発売目標日をあわせて表示してください。本文中の延期経緯の表と対応する内容です。
```
...
実際、2026年9月には『Marvel’s Wolverine』『Fire Emblem: Fortune’s Weave』『Control Resonant』など、複数の有力作が近い日程に並ぶ。GameSpotも、GTA6が11月に発売されることを背景に、開発各社が前後の月へ日程を配置しようとして9月が過密になったと報じている。[[9](#ref-9)]
...
```
# 仕上げAIへ図表制作依頼
GTA6の発売日（2026年11月19日）を中心に置いた「重力圏」の概念図を作成してください。GTA6の発売日を軸として、その前後の月（2026年9月・10月・12月など）に主要タイトルがどのように配置・移動しているかを示す模式図とし、本文で触れた9月の過密状況（Valor Mortisの延期など）を補足する内容にしてください。
```
...
```
# 仕上げAIへ図表制作依頼
発売時期戦略における「直接競合」「注意競合」「市場イベント」の三層構造を図解してください。本文中の表の内容（各層で確認する相手・主なリスク）を、同心円状または階層図のような形で視覚的に整理し、新人プランナーが自社タイトルの発売時期を検討する際のチェックフローとして使える構成にしてください。
```
