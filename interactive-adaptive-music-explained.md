---
description: "映画では、音楽はあらかじめ決まった映像の長さに合わせて作られる。ところがゲームでは、プレイヤーが何をするかを開発者は予測できない。敵に気づかれた瞬間、ボスのHPが半分を切った瞬間、あるいは仲間との感動の再会——これらは全て、プレイヤーの選択と行動によってタイミングが変わる。"
---

# インタラクティブ／アダプティブミュージック――変化するゲーム音楽の設計と実装
