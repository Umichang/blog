...
- **イチカラ村の建設クエスト**：移住者が増えるにつれて、その村人に合わせた楽器・サウンドがBGMに追加されていく。最終的には多くの音が重なり合い、豊かな合奏へと発展する[[31](#ref-31)]
...
### 2-8. Ghost of Tsushima（2020年、PS4）

**Ghost of Tsushima**（開発：サッカーパンチ）は、和楽器と西洋オーケストラを融合させたサウンドで高く評価されている。作曲はイラン・エシュケリと梅林茂が担当した。[[30](#ref-30)]

戦闘や探索といったゲーム状態に応じて、Wwise上で横の遷移・縦の遷移を用いて楽曲がシームレスに変化する。各楽曲には反復を避けるための多数の代替ステムが用意されており、同じ素材から変化に富んだ表情を生み出している。和楽器を活かしたインタラクティブミュージックの実装事例として注目される。[[29](#ref-29)]

### 2-9. ファイナルファンタジーXV MAGIシステム（2016年、PS4）
...
| ツール | 特徴 |
|-------|------|
| **Wwise**（Audiokinetic社） | 業界標準。エースコンバット7、Ghost of Tsushima、ポケモンSVなど多くのAAAタイトルで採用。サウンドデザイナーがエンジニアに依頼せず自分でインタラクティブ演出を実装できる[[5](#ref-5)] |
...
<a id="ref-8"></a>8. [iMUSE: LucasArts' Interactive Music System][8] - 1990年代初頭にLucasArtsが開発したインタラクティブ音楽システムの概要。
...
<a id="ref-29"></a>29. [The Interactive Music of Ghost of Tsushima – Game Music Hub][29] - ゲーム状態に応じた横/縦の遷移、Wwise、反復回避のための代替ステムの解説。

<a id="ref-30"></a>30. [Ghost of Tsushima (Music from the Video Game)][30] - 作曲者イラン・エシュケリと梅林茂、和楽器と西洋オーケストラの融合。

<a id="ref-31"></a>31. [「ゼルダの伝説ブレスオブザワイルド」名曲ランキングTOP10][31] - イチカラ村で村人が増えるにつれサウンドが追加されていく演出の紹介。
...
[8]: https://www.scribd.com/document/445662191/IMUSE
...
[29]: https://gamemusichub.net/2022/07/20/the-interactive-music-of-ghost-of-tsushima/
[30]: https://classical.music.apple.com/us/album/1521542376
[31]: https://yoshidashigeru.com/zelda-breathofthewild-ranking/
